...
import 'package:rick_and_morty_api/future/presentation/bloc/person_list_cubit/person_list_state.dart';
import 'package:rick_and_morty_api/future/presentation/widgets/person_card_widget.dart';
      ...
      return ListView.separated(
        ...
        itemBuilder: (context, index) {
          if(index<persons.length){
            ...
            Timer(Duration(milliseconds: 30),(){scrollController.jumpTo(scrollController.position.maxScrollExtent);});
            return _loadingIndicator();
          }
        },
